...
const WorkHistoryTileSection = ({ job }) => {
  return (
    <div className="container my-10 pr-4 flex flex-row phone:flex-col phone:items-center bg-secondary rounded-3xl shadow-xl">
      <div className=" w-1/3 flex flex-col items-center justify-center text-[#022C3A] border-r-2 border-[#022C3A] phone:border-r-0 phone:border-b-2 pt-10 ">
        <h2 className="text-[#022C3A] text-3xl">{job.companyTitle}</h2>
        <p>{job.location}</p>
      </div>
