export const workHistory = [
  {
    ...
    responsibilities: [
      "Specialized in payment processing and checkout architecture for MLB's ticketing platform, delivering secure, reliable purchasing experiences at enterprise scale.",
      "Led implementation of Apple Pay, Google Pay, and Mastercard Click to Pay, expanding digital wallet support and improving checkout flexibility for fans purchasing tickets online.",
      "Designed and delivered major enhancements to Guest Checkout, including payment workflows, buyer types, service charge mapping, parking purchases, cart improvements, and upsell experiences.",
      "Integrated Accertify Real-Time Fraud Detection into the checkout experience, improving fraud prevention while maintaining a seamless purchasing flow.",
      "Developed reusable frontend components and application architecture using React, TypeScript, AngularJS, Node.js, and Next.js within a large NX monorepo.",
      "Implemented and enhanced View From Seat and 3D Seat Map experiences, improving ticket discovery and purchase confidence for fans.",
      "Built production monitoring, alerting, and observability dashboards using Datadog to proactively identify issues and improve application reliability.",
      "Partner closely with Product Managers, UX Designers, QA Engineers, backend teams, and external vendors to deliver customer-focused features from concept through production.",
      "Contribute to architecture discussions, code reviews, technical planning, and mentoring to improve engineering quality and maintainability.",
      "Deliver highly reliable software supporting major sales events, including Opening Day, playoffs, and other high-demand ticket releases.",
    ],
  },
  {
    id: "1",
